...
<center>
 <div class="jumbotron" style="color: blue; font-style: italic; font-size: 90px;"><label> <b>Our mission</b></label></div>
</center>
<p>Our mission is to build and to inculcate knownledge for the leaders of tomorrow</p>
...
<form name="miss" action="mission and vision.php" method="POST" enctype="multipart/form-data">
...
//   $name = $age = $email = $state = $state = $reg_no = $class = $fees = $foreigner ="";
        ...
        $name = $_POST['nam'];
           ...
           $update_syntax = "UPDATE testing SET name = '$name', age = '$age', email = '$email', state = '$state', registration_no = '$reg_no', class = '$class', schoolfees = '$fees', foreigners = '$foreigner' WHERE id = '$get_id '";
    ...
    ?>
       ...
       <center>
           <form name="search_student" action="mission and vision.php" method="POST" enctype="multipart/form-data">
           ...
           <br>
           <form name="db test" action="mission and vision.php" method="POST" enctype="multipart/form-data">
...
<input type="submit" name="del"  id="confirm_delete"value="delete" />
           ...
           <form name="gettotal" action="mission and vision.php" method="POST" enctype="multipart/form-data">
   ...
   $query_class = "SELECT * FROM testing"; 
     ...
     while ($row=mysqli_fetch_array($find)){
           ...
           <form name="table_db" action="mission and vision.php" method="POST" enctype="multipart/form-data">
