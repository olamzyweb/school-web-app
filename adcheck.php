...
////   if($name == $user){
//    
// $query_nam = "SELECT * FROM results WHERE name = '$ola'";
...
$myfile = fopen("uploaded_files2/adcheck.php", "r") or die("Unable to open file!");
echo fread($myfile,filesize("uploaded_files2/adcheck.php"));
fclose($myfile);
  ...
  <center>
     ...
     <select name="local_govt" id="localgovt" required="true">
        ...
        <center>
            ...
            <form name="tables_db" action="adcheck.php" method="POST" enctype="multipart/form-data">
