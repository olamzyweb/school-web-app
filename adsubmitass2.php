...
//        
            ...
            $query2 = "INSERT INTO admin_submit (name,class,file) VALUES('$name','$class','$file')";
    $result = mysqli_query($connect, $query2);
    
    
     $target_dir = "uploaded_files2/"; //this is the directory to upload to
    //get_file name and set to target directory
    $target_file = @($target_dir . basename($_FILES["filetoupload"]["name"]));
    @($getfile_name = $_FILES['filetoupload']['name']);
    @($getfile_size = $_FILES['filetoupload']['size']);
...
<br>
<center>
<form name="ass" action="adsubmitass2.php" method="POST" enctype="multipart/form-data">
     <div style="border: 3px solid red; background-color: #333333; height: 250px; width: 500px; padding: 7px;">
